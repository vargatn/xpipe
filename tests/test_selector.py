...
class TestSelector(object):
    def test_1d(self, mock_data):
        ...
        ans_bounds = [((0, (0.2, 0.4)),), ((0, (0.4, 0.6)),), ((0, (0.6, 0.8)),)]
        ans_plpairs = [[(0, (0.2, 0.4)), (0, (0.4, 0.6)), (0, (0.6, 0.8))]]
        ans_sinds = [
    ...
    def test_2d(self, mock_data):
        ...
        ans_plpairs = [[(0, (0.0, 200)), (0, (200, 300)), (0, (300, 360.0))],
                       [(1, (-60.0, -30.0)), (1, (-30.0, 10.0))]]

        ans_bounds = [
            ((0, (0.0, 200)), (1, (-60.0, -30.0))),
            ((0, (0.0, 200)), (1, (-30.0, 10.0))),
            ((0, (200, 300)), (1, (-60.0, -30.0))),
            ((0, (200, 300)), (1, (-30.0, 10.0))),
            ((0, (300, 360.0)), (1, (-60.0, -30.0))),
            ((0, (300, 360.0)), (1, (-30.0, 10.0)))
        ]
        ans_sinds = np.array([
    ...
    def test_3d(self, mock_data):
        ...
        ans_plpairs = [[(0, (0.0, 200)), (0, (200, 360.0))],
                       [(1, (-60.0, -30.0)), (1, (-30.0, 10.0))],
                       [(2, (0.2, 0.4)), (2, (0.4, 0.8))]]
        ans_bounds = [
             ((0, (0.0, 200)), (1, (-60.0, -30.0)), (2, (0.2, 0.4))),
             ((0, (0.0, 200)), (1, (-60.0, -30.0)), (2, (0.4, 0.8))),
             ((0, (0.0, 200)), (1, (-30.0, 10.0)), (2, (0.2, 0.4))),
             ((0, (0.0, 200)), (1, (-30.0, 10.0)), (2, (0.4, 0.8))),
             ((0, (200, 360.0)), (1, (-60.0, -30.0)), (2, (0.2, 0.4))),
             ((0, (200, 360.0)), (1, (-60.0, -30.0)), (2, (0.4, 0.8))),
             ((0, (200, 360.0)), (1, (-30.0, 10.0)), (2, (0.2, 0.4))),
             ((0, (200, 360.0)), (1, (-30.0, 10.0)), (2, (0.4, 0.8)))
        ]
